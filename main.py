...
def get_args_parser():
    ...
    parser.add_argument('--data-path', default='./tiny-imagenet-200', type=str,
                        help='dataset path')
    # parser.add_argument('--data-path', default='/media/tejabale/Acer/Users/tejab/Downloads/imagenet', type=str,
    #                     help='dataset path')
    # parser.add_argument('--data-path', default='/kaggle/input/tiny-imagenet/tiny-imagenet-200', type=str,
    #                     help='dataset path')
